...
$has_form = get_field('avb_hide_form') ? '' : 'avb-has-form';
$banners = get_field('avb');
$country = get_field('travel_guide_country');
...
?>
    ...
    <section class="avb">
        ...
        <div class="avb-banners avb-<?php echo $banner_height.'vh'; ?> avb-dots-<?php echo $banner_dots_position; ?> <?php echo $avb_page; ?> <?php echo $has_form; ?>">
            <?php
                $avb_count = 1;
